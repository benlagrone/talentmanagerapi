...
module.exports = (app) => {
  ...
  // app.put('/api/answers', answersController.update);
  // app.put('/api/assessments', assessmentsController.update);
  app.put('/api/categories/:id', categoriesController.update);
  app.put('/api/groups/:id', groupsController.update);
  // app.put('/api/questionlibraries', questionlibrariesController.update);
  ...
  // app.delete('/api/answers', answersController.remove);
  // app.delete('/api/assessments', assessmentsController.remove);
  app.delete('/api/categories/:id', categoriesController.remove);
  app.delete('/api/groups/:id', groupsController.remove);
  // app.delete('/api/questionlibraries', questionlibrariesController.remove);
